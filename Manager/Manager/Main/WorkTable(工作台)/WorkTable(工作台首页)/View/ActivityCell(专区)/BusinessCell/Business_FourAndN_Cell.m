...
#import "Business_FourAndN_Cell.h"
#import "GoodsView2.h"

@interface Business_FourAndN_Cell()
...
@implementation Business_FourAndN_Cell
...
- (void)awakeFromNib {
    ...
    CGFloat height = 140;
    CGFloat space = 5;
    self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH , height)];
...
- (void)setBusinessArray:(NSArray *)businessArray {
    ...
    CGFloat height = 140;
    CGFloat space = 5;
    self.scrollView.contentSize = CGSizeMake(10 + (width + space) * (businessArray.count - 4), height);
}
